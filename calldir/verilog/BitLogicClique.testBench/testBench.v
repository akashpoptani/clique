...
module testBench
  ...
  // register begin
  always @(posedge \BitLogicClique.testBench_clk  or  posedge  \c$BitLogicClique.testBench_app_arg ) begin : s_register
    if ( \c$BitLogicClique.testBench_app_arg ) begin
      s <= 2'd0;
    end else begin
      s <= c$ds_app_arg;
    end
  ...
  assign \BitLogicClique.testBench_clk  = clk;
  // pragma translate_on
  // tbClockGen end
  ...
  // register begin
  always @(posedge \BitLogicClique.testBench_clk  or  posedge  \c$BitLogicClique.testBench_app_arg ) begin : s_0_register
    if ( \c$BitLogicClique.testBench_app_arg ) begin
      s_0 <= 2'd0;
    end else begin
      s_0 <= result_1;
  ...
  // assert begin
  // pragma translate_off
  always @(posedge \BitLogicClique.testBench_clk ) begin
  ...
  // register begin
  always @(posedge \BitLogicClique.testBench_clk  or  posedge  \c$BitLogicClique.testBench_app_arg ) begin : f_register
    if ( \c$BitLogicClique.testBench_app_arg ) begin
      \f'  <= 1'b0;
    end else begin
      \f'  <= (s_0 == 2'd3);
  ...
  `verilog
  `endif
  assign \c$BitLogicClique.testBench_app_arg  = rst;
  // pragma translate_on
  // resetGen end
